...
- If your menu isn't appearing than an anticheat may be blocking it from loading, on CS2 make sure that `-insecure` and/or `-allow_third_party_software` is enabled in launch properties. Otherwise run your game offline or with the anticheat disabled.
